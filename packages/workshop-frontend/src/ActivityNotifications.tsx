    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <div className="flex items-center justify-between gap-2 px-3.5 pb-1 pt-2.5">
          <Popover.Title className="text-[12px] md:text-[11px] font-medium uppercase tracking-[0.06em] text-kumo-inactive">
            Needs review
          </Popover.Title>
        ...
        {pending.length === 0 ? (
          <p className="m-0 px-3.5 pb-3 pt-1 text-[14px] md:text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    >
                      <span className="block truncate text-[14px] md:text-[13px] font-medium leading-[18px] tracking-[-0.25px] text-kumo-default">
                        {action.description.title}
                      </span>
                      <span className="mt-0.5 block truncate text-[12.5px] md:text-[11.5px] leading-4 tracking-[-0.1px] text-kumo-inactive">
        ...
        <div className="border-t border-kumo-line p-1">
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-between rounded-md px-2.5 py-1.5 text-left text-[14px] md:text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-default transition-colors hover:bg-kumo-tint focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-kumo-ring"
          >
            <span>
