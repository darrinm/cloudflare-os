  ...
  return (
    <div className="flex h-full w-[244px] flex-col border-r border-kumo-line bg-kumo-base">
      <div className="flex h-9 shrink-0 items-center justify-between gap-2 px-3 pt-3 pb-2">
        <span className="text-[12px] md:text-[11px] font-medium uppercase tracking-[0.08em] text-kumo-inactive">
          Files
        </span>
        <WorkshopIconButton
...
function FileRow({
  ...
  return (
    <div
      className={[
        'group relative mb-[2px] flex h-7 items-center gap-2 rounded-md px-2 text-[14px] md:text-[13px] leading-[18px] tracking-[-0.2px] transition-[background-color,box-shadow,color,opacity] duration-150 ease-out',
        isRenaming
    ...
    >
      ...
      {isRenaming ? (
        <input
          ...
          className="min-w-0 flex-1 bg-transparent text-[14px] md:text-[13px] leading-[18px] tracking-[-0.2px] text-kumo-default outline-none placeholder:text-kumo-inactive"
        />
      ) : (
        <button
          type="button"
          className="flex min-w-0 flex-1 cursor-pointer items-center gap-2 self-stretch bg-transparent p-0 text-left text-[14px] md:text-[13px] leading-[18px] tracking-[-0.2px] text-inherit outline-none focus-visible:ring-2 focus-visible:ring-kumo-ring focus-visible:ring-offset-1 focus-visible:ring-offset-kumo-base"
