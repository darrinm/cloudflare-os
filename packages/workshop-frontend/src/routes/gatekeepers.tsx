...
function ConnectorCard({
  ...
  const badgeEl = badge ? (
    <span
      className={`shrink-0 rounded-full px-1.5 py-0.5 text-[11px] md:text-[10px] leading-3 font-semibold uppercase tracking-[0.4px] ${
        badge.tone === 'new'
    ...
    return (
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          {(metaLine || tagline) && (
            <div className="mt-0.5 truncate text-[13px] md:text-[12px] leading-4 font-normal tracking-[-0.2px] text-kumo-subtle">
              {metaLine ?? tagline}
            </div>
          )}
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        {metaLine && (
          <div className="mt-0.5 flex items-center gap-1.5 text-[13px] md:text-[12px] leading-4 font-normal tracking-[-0.2px] text-kumo-subtle">
            {metaLine}
          </div>
        )}
        {tagline && (
          <p className="mt-2 line-clamp-2 text-[14px] md:text-[13px] leading-[18px] font-normal tracking-[-0.25px] text-kumo-subtle">
            {tagline}
          </p>
        )}
      </div>
...
function SectionEyebrow({ label, count }: { label: string; count?: number }) {
  return (
    <div className="mb-3.5 flex items-center gap-3 px-1">
      <h2 className="m-0 text-[12px] md:text-[11px] leading-4 font-semibold uppercase tracking-[0.9px] text-kumo-subtle">
        {label}
      </h2>
      <div className="h-px flex-1 bg-kumo-line" />
      {typeof count === 'number' && (
        <span className="text-[12px] md:text-[11px] leading-4 font-semibold tracking-[-0.1px] text-kumo-inactive">
          {count}
        </span>
      )}
    </div>
      ...
      <div className="group absolute left-[176px] top-[58px] z-20">
        ...
        <div className="themed-floating-shadow-lg pointer-events-none absolute left-1/2 top-[-108px] z-30 w-[228px] origin-bottom -translate-x-1/2 translate-y-1 scale-[0.98] rounded-2xl border border-kumo-line bg-kumo-base p-3 text-left opacity-0 transition-[opacity,transform] delay-0 duration-150 ease-out group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 group-hover:delay-100 group-focus-within:translate-y-0 group-focus-within:scale-100 group-focus-within:opacity-100 group-focus-within:delay-100">
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0">
              <p className="m-0 text-[13px] md:text-[12px] leading-4 font-semibold tracking-[-0.2px] text-kumo-default">
                Gatekeeper
              </p>
        ...
        <div className="mb-6 flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-lg border border-kumo-line bg-kumo-base pl-9 pr-4 text-[15px] md:text-[14px] leading-5 tracking-[-0.25px] text-kumo-default placeholder:text-kumo-inactive transition-[border-color,box-shadow] focus:border-kumo-ring focus:outline-none focus:ring-[3px] focus:ring-kumo-ring/15"
            />
          </div>
