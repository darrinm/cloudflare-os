...
export function BlueprintBindingCard({
  ...
  const footerClass = flat
    ? 'flex items-center [&_label]:!text-[13px] md:text-[12px] [&_label]:!leading-4 [&_label]:!tracking-[-0.2px] [&_label]:!font-normal [&_label]:!text-kumo-subtle'
    : 'mt-2 flex items-center border-t border-kumo-line/70 px-3 py-2 [&_label]:!text-[13px] md:text-[12px] [&_label]:!leading-4 [&_label]:!tracking-[-0.2px] [&_label]:!font-normal [&_label]:!text-kumo-subtle'
      ...
      <div className={headerClass}>
        ...
        <div className="min-w-0 flex-1">
          ...
          <WorkshopInput
            ...
            className="!h-8 w-full bg-kumo-base text-[14px] md:text-[13px] leading-5 font-medium tracking-[-0.25px]"
          />
          <p className="mt-1 text-[12px] md:text-[11px] leading-4 tracking-[-0.1px] text-kumo-inactive">
