  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-dashed border-kumo-line bg-kumo-base px-6 py-9 text-center">
      ...
      <div className="relative">
        <p className="m-0 text-[15px] md:text-[14px] leading-5 font-medium tracking-[-0.3px] text-kumo-default">
          {title}
        </p>
        <p className="mx-auto mt-1 max-w-sm text-[14px] md:text-[13px] leading-[18px] font-normal tracking-[-0.25px] text-kumo-subtle">
          {description}
        </p>
      </div>
