...
const COMPOSER_MENU_ITEM =
  '!h-auto rounded-xl !px-2 !py-1.5 text-[13px] md:text-[12px] leading-4 font-normal tracking-[-0.15px] ' +
...
export default function ComposerFormatMenuItems({
  ...
  return (
    <>
      <p className="px-2 pb-1 pt-1.5 text-[11px] md:text-[10px] font-medium uppercase leading-4 tracking-[0.06em] text-kumo-inactive">
        Start with
      </p>
      {formats.map((format) => (
        <DropdownMenu.Item
