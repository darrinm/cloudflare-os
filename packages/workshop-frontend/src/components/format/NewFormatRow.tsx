      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {formats.map((format) => (
          <button
            ...
            className="press flex cursor-pointer items-center gap-2 rounded-full border border-kumo-line bg-kumo-base px-3.5 py-2 text-[14px] md:text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-default transition-colors duration-150 ease-out hover:bg-kumo-tint disabled:cursor-default disabled:opacity-60"
          >
            <FormatGlyph
