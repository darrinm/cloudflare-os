...
const CONTENT = {
  'access-denied': {
    ...
    message: 'Ask the project owner to grant you access, then try again.',
    Icon: Lock,
    retryable: true,
  },
  'not-found': {
    title: 'Project not found',
    message: 'The link may be incorrect, or the project may have been deleted.',
    Icon: MagnifyingGlass,
    retryable: false,
  },
  unexpected: {
    title: "We couldn't load this project",
    message: 'Try again. If the problem continues, return to your projects.',
    Icon: WarningCircle,
    retryable: true,
  },
} as const
  ...
  return (
    <div className="flex min-h-full items-center justify-center bg-kumo-base px-6 py-12">
      ...
      >
        ...
        <p
          id={descriptionId}
          className="mt-2 text-[14px] md:text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle"
        >
          {message}
        </p>
