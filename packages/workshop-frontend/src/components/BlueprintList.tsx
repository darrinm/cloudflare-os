...
const ACTION_BUTTON =
  'press inline-flex h-9 w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-kumo-line bg-kumo-base px-3.5 text-[14px] md:text-[13px] font-medium tracking-[-0.25px] text-kumo-default transition-colors hover:bg-kumo-tint disabled:cursor-default disabled:opacity-50'
            ...
            <div className="flex flex-col items-center gap-3 px-3 py-16 text-center">
              ...
              <div>
                ...
                <p className="mt-1 text-[14px] md:text-[13px] leading-[18px] text-kumo-subtle">
                  Publish a project as a template, or add one from Explore.
                </p>
              </div>
