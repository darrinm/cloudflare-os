...
export const PICKER_CAPTION =
  'text-[12px] md:text-[11px] font-medium uppercase leading-4 tracking-[0.06em] text-kumo-inactive'
...
export const PICKER_EMPTY =
  'm-0 px-3.5 py-3 text-[14px] md:text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle'
...
export function TabHint() {
  return (
    <kbd
      aria-hidden="true"
      className="flex-shrink-0 rounded border border-kumo-line bg-kumo-base px-1 py-px font-sans text-[11px] md:text-[10px] font-medium leading-4 tracking-[0.02em] text-kumo-subtle"
    >
      Tab
    </kbd>
  )
