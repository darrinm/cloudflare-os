...
export default function ConnectConnectorModal({
  ...
  const headerSubline = isManage ? (
    <div className="mt-0.5 flex items-center gap-1.5 text-[14px] md:text-[13px] leading-[18px] font-normal tracking-[-0.25px] text-kumo-subtle">
      <span
    ...
    vendorDescription.tagline && (
      <Dialog.Description className="mt-0.5 text-[14px] md:text-[13px] leading-[18px] font-normal tracking-[-0.25px] text-kumo-subtle">
        {vendorDescription.tagline}
      </Dialog.Description>
    )
  )
      ...
      >
        ...
        <div className="new-gatekeeper-scroll-balanced min-h-0 flex-1 overflow-y-auto px-5 py-4">
          {vendorDescription.description && (
            <p className="text-[14px] md:text-[13px] leading-[19px] font-normal tracking-[-0.25px] text-kumo-default">
              {vendorDescription.description}
            </p>
          )}
          ...
          {supportedResources.length > 0 && (
            <div className="mt-5">
              <h3 className="mb-2 text-[13px] md:text-[12px] leading-4 font-semibold uppercase tracking-[0.6px] text-kumo-inactive">
                {granular
                  ? isManage
                    ? 'Resources'
                    : 'Resources to enable'
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-[14px] md:text-[13px] leading-[18px] font-medium tracking-[-0.25px] text-kumo-default">
                          {resource.title}
                        </p>
            ...
            >
              <div className="flex items-start gap-3">
                <ShieldCheck
                  ...
                  weight="duotone"
                />
                <div className="text-[13px] md:text-[12px] leading-[17px] font-normal tracking-[-0.2px] text-kumo-default">
        ...
        <div className="shrink-0 flex items-center justify-between gap-3 border-t border-kumo-line bg-kumo-base px-5 py-3">
          {isManage && confirmingDisconnect ? (
            <p className="m-0 min-w-0 flex-1 text-[13px] md:text-[12px] leading-4 font-normal tracking-[-0.2px] text-kumo-default">
              Disconnect {vendorDescription.displayName}? Gadgets using this will lose access.
            </p>
          ) : isManage && hasPending ? (
            <p className="m-0 min-w-0 flex-1 text-[13px] md:text-[12px] leading-4 font-normal tracking-[-0.2px] text-kumo-subtle">
